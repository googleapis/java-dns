...
import static com.google.cloud.dns.v1.stub.HttpJsonProjectStub.getProjectMethodDescriptor;
...
public class ProjectClientTest {
  ...
  private static final List<ApiMethodDescriptor> METHOD_DESCRIPTORS =
      ImmutableList.copyOf(Lists.<ApiMethodDescriptor>newArrayList(getProjectMethodDescriptor));
  ...
  public void getProjectTest() {
    ...
    String number = "number-1034364087";
    Project expectedResponse =
        Project.newBuilder().setId(id).setKind(kind).setNumber(number).build();
