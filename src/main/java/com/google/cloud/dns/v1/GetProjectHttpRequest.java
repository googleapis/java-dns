...
@Generated("by GAPIC")
@BetaApi
/** Request object for method dns.projects.get. Fetch the representation of an existing Project. */
public final class GetProjectHttpRequest implements ApiMessage {
  ...
  /**
   * Identifies the project addressed by this request. It must have the format `{project}`.
