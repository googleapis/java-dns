...
@Generated("by GAPIC")
@BetaApi
/** Request object for method dns.dnsKeys.get. Fetch the representation of an existing DnsKey. */
public final class GetDnsKeyHttpRequest implements ApiMessage {
  ...
  /**
   * The identifier of the requested DnsKey. It must have the format
   * `{project}/managedZones/{managedZone}/dnsKeys/{dnsKeyId}`. \`{dnsKeyId}\` must start with a
  ...
  public static Builder newBuilder(GetDnsKeyHttpRequest prototype) {
  ...
  public static GetDnsKeyHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final GetDnsKeyHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new GetDnsKeyHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetDnsKeyHttpRequest other) {
      if (other == GetDnsKeyHttpRequest.getDefaultInstance()) return this;
      ...
      if (other.getDnsKeyId() != null) {
        this.dnsKeyId = other.dnsKeyId;
      }
    ...
    public GetDnsKeyHttpRequest build() {
      String missing = "";
      ...
      return new GetDnsKeyHttpRequest(
          access_token,
          callback,
          clientOperationId,
          digestType,
    ...
    public Builder clone() {
      ...
      newBuilder.setDnsKeyId(this.dnsKeyId);
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof GetDnsKeyHttpRequest) {
      GetDnsKeyHttpRequest that = (GetDnsKeyHttpRequest) o;
      return Objects.equals(this.access_token, that.getAccessToken())
          ...
          && Objects.equals(this.dnsKeyId, that.getDnsKeyId())
