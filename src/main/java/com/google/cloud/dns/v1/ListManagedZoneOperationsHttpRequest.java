...
@BetaApi
/**
 * Request object for method dns.managedZoneOperations.list. Enumerate Operations for the given
 * ManagedZone.
 */
public final class ListManagedZoneOperationsHttpRequest implements ApiMessage {
  ...
  private ListManagedZoneOperationsHttpRequest() {
  ...
  /**
   * Identifies the managed zone addressed by this request. It must have the format
   * `{project}/managedZones/{managedZone}/operations`. \`{managedZone}\` must start with a letter,
  ...
  public static Builder newBuilder(ListManagedZoneOperationsHttpRequest prototype) {
  ...
  public static ListManagedZoneOperationsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListManagedZoneOperationsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListManagedZoneOperationsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListManagedZoneOperationsHttpRequest other) {
      if (other == ListManagedZoneOperationsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListManagedZoneOperationsHttpRequest source) {
    ...
    /**
     * Identifies the managed zone addressed by this request. It must have the format
     * `{project}/managedZones/{managedZone}/operations`. \`{managedZone}\` must start with a
    ...
    public ListManagedZoneOperationsHttpRequest build() {
      String missing = "";
      ...
      return new ListManagedZoneOperationsHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "ListManagedZoneOperationsHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListManagedZoneOperationsHttpRequest) {
      ListManagedZoneOperationsHttpRequest that = (ListManagedZoneOperationsHttpRequest) o;
