...
public abstract class DnsKeyStub implements BackgroundResource {

  @BetaApi
  public UnaryCallable<GetDnsKeyHttpRequest, DnsKey> getDnsKeyCallable() {
    throw new UnsupportedOperationException("Not implemented: getDnsKeyCallable()");
  }

  @BetaApi
  public UnaryCallable<ListDnsKeysHttpRequest, ListDnsKeysPagedResponse>
      listDnsKeysPagedCallable() {
    throw new UnsupportedOperationException("Not implemented: listDnsKeysPagedCallable()");
  }

  @BetaApi
  public UnaryCallable<ListDnsKeysHttpRequest, DnsKeysListResponse> listDnsKeysCallable() {
    throw new UnsupportedOperationException("Not implemented: listDnsKeysCallable()");
  }
