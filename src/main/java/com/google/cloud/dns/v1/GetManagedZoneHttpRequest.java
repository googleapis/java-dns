...
@BetaApi
/**
 * Request object for method dns.managedZones.get. Fetch the representation of an existing
 * ManagedZone.
 */
public final class GetManagedZoneHttpRequest implements ApiMessage {
  ...
  private GetManagedZoneHttpRequest() {
  ...
  public static Builder newBuilder(GetManagedZoneHttpRequest prototype) {
  ...
  public static GetManagedZoneHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final GetManagedZoneHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new GetManagedZoneHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetManagedZoneHttpRequest other) {
      if (other == GetManagedZoneHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetManagedZoneHttpRequest source) {
    ...
    public GetManagedZoneHttpRequest build() {
      String missing = "";
      ...
      return new GetManagedZoneHttpRequest(
          access_token,
          callback,
          clientOperationId,
          fields,
  ...
  public String toString() {
    return "GetManagedZoneHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof GetManagedZoneHttpRequest) {
      GetManagedZoneHttpRequest that = (GetManagedZoneHttpRequest) o;
