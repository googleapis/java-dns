...
@Generated("by GAPIC")
@BetaApi
/** Request object for method dns.policies.patch. Apply a partial update to an existing Policy. */
public final class PatchPolicyHttpRequest implements ApiMessage {
  ...
  private PatchPolicyHttpRequest() {
  ...
  public static Builder newBuilder(PatchPolicyHttpRequest prototype) {
  ...
  public static PatchPolicyHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final PatchPolicyHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new PatchPolicyHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(PatchPolicyHttpRequest other) {
      if (other == PatchPolicyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(PatchPolicyHttpRequest source) {
    ...
    public PatchPolicyHttpRequest build() {
      String missing = "";
      ...
      return new PatchPolicyHttpRequest(
          access_token,
          callback,
          clientOperationId,
          fieldMask,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof PatchPolicyHttpRequest) {
      PatchPolicyHttpRequest that = (PatchPolicyHttpRequest) o;
