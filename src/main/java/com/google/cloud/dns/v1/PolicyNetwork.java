...
@Generated("by GAPIC")
@BetaApi
public final class PolicyNetwork implements ApiMessage {
  ...
  private PolicyNetwork(String kind, String networkUrl) {
    this.kind = kind;
  ...
  public static Builder newBuilder(PolicyNetwork prototype) {
  ...
  public static PolicyNetwork getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final PolicyNetwork DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new PolicyNetwork();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(PolicyNetwork other) {
      if (other == PolicyNetwork.getDefaultInstance()) return this;
    ...
    public PolicyNetwork build() {
      ...
      return new PolicyNetwork(kind, networkUrl);
    }
  ...
  public String toString() {
    return "PolicyNetwork{" + "kind=" + kind + ", " + "networkUrl=" + networkUrl + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof PolicyNetwork) {
      PolicyNetwork that = (PolicyNetwork) o;
