...
public abstract class ChangeStub implements BackgroundResource {

  @BetaApi
  public UnaryCallable<CreateChangeHttpRequest, Change> createChangeCallable() {
    throw new UnsupportedOperationException("Not implemented: createChangeCallable()");
  }

  @BetaApi
  public UnaryCallable<GetChangeHttpRequest, Change> getChangeCallable() {
    throw new UnsupportedOperationException("Not implemented: getChangeCallable()");
  }

  @BetaApi
  public UnaryCallable<ListChangesHttpRequest, ListChangesPagedResponse>
      listChangesPagedCallable() {
    throw new UnsupportedOperationException("Not implemented: listChangesPagedCallable()");
  }

  @BetaApi
  public UnaryCallable<ListChangesHttpRequest, ChangesListResponse> listChangesCallable() {
    throw new UnsupportedOperationException("Not implemented: listChangesCallable()");
  }
