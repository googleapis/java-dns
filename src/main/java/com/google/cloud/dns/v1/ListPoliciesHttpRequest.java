...
@BetaApi
/**
 * Request object for method dns.policies.list. Enumerate all Policies associated with a project.
 */
public final class ListPoliciesHttpRequest implements ApiMessage {
  ...
  private ListPoliciesHttpRequest() {
  ...
  /**
   * Identifies the project addressed by this request. It must have the format `{project}/policies`.
  ...
  public static Builder newBuilder(ListPoliciesHttpRequest prototype) {
  ...
  public static ListPoliciesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListPoliciesHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListPoliciesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListPoliciesHttpRequest other) {
      if (other == ListPoliciesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListPoliciesHttpRequest source) {
     ...
     * `{project}/policies`. \`{project}\` must start with a letter, and contain only letters
    ...
    public ListPoliciesHttpRequest build() {
      String missing = "";
      ...
      return new ListPoliciesHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "ListPoliciesHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListPoliciesHttpRequest) {
      ListPoliciesHttpRequest that = (ListPoliciesHttpRequest) o;
