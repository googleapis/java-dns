...
@BetaApi
/**
 * Request object for method dns.policies.delete. Delete a previously created Policy. Will fail if
 * the policy is still being referenced by a network.
 */
public final class DeletePolicyHttpRequest implements ApiMessage {
  ...
  private DeletePolicyHttpRequest() {
  ...
  public static Builder newBuilder(DeletePolicyHttpRequest prototype) {
  ...
  public static DeletePolicyHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final DeletePolicyHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new DeletePolicyHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(DeletePolicyHttpRequest other) {
      if (other == DeletePolicyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(DeletePolicyHttpRequest source) {
    ...
    public DeletePolicyHttpRequest build() {
      String missing = "";
      ...
      return new DeletePolicyHttpRequest(
          access_token,
          callback,
          clientOperationId,
          fields,
  ...
  public String toString() {
    return "DeletePolicyHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof DeletePolicyHttpRequest) {
      DeletePolicyHttpRequest that = (DeletePolicyHttpRequest) o;
